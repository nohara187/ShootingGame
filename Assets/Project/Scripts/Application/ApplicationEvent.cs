...
namespace nohara.samplegame
{
	public class ApplicationEvent {
		...
		public const string REQUEST_LABEL_UPDATE_SPEED = "REQUEST_LABEL_UPDATE_SPEED";
		public const string REQUEST_LABEL_UPDATE_TIMER = "REQUEST_LABEL_UPDATE_TIMER";
		public const string REQUEST_LABEL_UPDATE_POINT = "REQUEST_LABEL_UPDATE_POINT";
